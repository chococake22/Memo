...
public class LoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    protected LoginAuthenticationFilter(final String defaultFilterProcessesUrl,
                                        final AuthenticationManager authenticationManager) {

        // defaultFilterProcessesUrl로 들어오는 요청을 authenticationManager가 authentication 객체를 이용해서 검증한다.
